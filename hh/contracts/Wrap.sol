...
contract Dev is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "WRAPPER #', toString(tokenId), '", "description": "minting rappers that you have found and want to claim some kind of ownership on their exposure  , by making a pixel generated  or  text  generated atrrubties of rapper you have found traits consists of ie style : melodic  or lyrical", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("Wrapperdex", "WRAPPER") Ownable() {}
}
